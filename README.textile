...
# "Download":https://github.com/NicolasGraph/oui_giphy/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_giphy:
@$ composer require oui/oui_giphy@
...
bc. $ composer update oui/oui_giphy
...
bc. $ composer remove oui/oui_giphy
...
oui_giphy version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* *oui_giphy v1.0.0-alpha* (2018-06-25)
